...
def generate_launch_description():
    ...
    declare_z = DeclareLaunchArgument('z', default_value='0.0925')
    ...
    # cmd_vel_splitter - điều khiển drive + lift
    ...
    return LaunchDescription([
        ...
        # Spawn controllers sau khi robot spawn xong
        TimerAction(period=5.0, actions=[joint_state_broadcaster_spawner]),
        TimerAction(period=5.5, actions=[lift_controller_spawner]),
        TimerAction(period=6.0, actions=[cmd_vel_splitter]),
    ])